...
if __name__ == '__main__':
    customers = [Customer('Bragi'), Customer('Auja'), Customer('Iris'), Customer('Axel'), Customer('Andrea'),
                 Customer('Agnar'), Customer('Mamma'), Customer('Solla'), Customer('Olla'), Customer('Berglind'),
                 Customer('Bergdis'), Customer('Margret'), Customer('Brynjar'), Customer('Siggi'), Customer('Tomas'),
                 Customer('Kristrun'), Customer('Heidrun')]
