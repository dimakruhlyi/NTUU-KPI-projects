...
namespace LAB_1
{
    public partial class Form1 : Form
    {
        ...
        private void debugSyntax3ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (New_object.get_check_error())
            {
                dataGridView4.Visible = true;
                dataGridView4.DataSource = New_object.Get_error_message();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            switch (state)
            {
                ...
                case 5:
                    POLIZ New_object1 = new POLIZ(richTextBox1.Text + '\n');
                    dataGridView6.DataSource = New_object1.Get_Data_Stan();
        ...
        {
            POLIZ New_object = new POLIZ(richTextBox1.Text + '\n');

            dataGridView6.DataSource = New_object.Get_Data_Stan();
            //dataGridView7.DataSource = New_object.Get_Data_Stack();
            button1.Visible = false;
            button2.Visible = false;
            dataGridView7.Location = new System.Drawing.Point(590, 533);
            dataGridView7.Size = new System.Drawing.Size(450, 200);
